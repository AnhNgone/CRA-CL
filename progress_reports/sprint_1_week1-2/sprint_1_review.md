...
## 5. Vấn đề phát hiện trong sprint — 4 mục đã khắc phục, 4 mục chuyển sang Sprint 2

### 5.1. Đã khắc phục trong sprint này
...
Ban đầu đánh giá ảnh hưởng là nhỏ và chỉ mang tính nguyên tắc. **Sai** — sau khi tính lại IV trên train, **3/16 biến đổi kết quả chọn**:
...
> **Lưu ý về con số:** AUC **giảm nhẹ 0.0018** sau khi sửa. Đây là điều đáng kỳ vọng — bỏ thông tin của tập test ra khỏi quy trình thì hiệu năng đo *trên chính tập test* phải giảm chút ít. 0.6516 là con số trung thực; 0.6534 đã bị thổi nhẹ. Cái được lớn hơn cái mất: scorecard nay diễn giải được (8/8 hệ số đúng dấu) nên mới thực sự dùng được theo chuẩn ngành credit risk.
>
...
## 6. Kế hoạch điều chỉnh cho Sprint 2
