...
| 2 dashboard hoàn chỉnh, chạy được, đúng nội dung mục 6 PROPOSAL.md | ☐ | |
| Final Recommendation nêu rõ yếu tố rủi ro chính, đề xuất cutoff, giới hạn mô hình | ☐ | |
| Toàn bộ 6 deliverables ở mục 9 PROPOSAL.md đã đóng gói | ☐ | |

## 3. Deliverables hoàn thành trong sprint
- [reports/business_rules_policy.md](../../reports/business_rules_policy.md)
- [reports/final_recommendation.md](../../reports/final_recommendation.md)
- Dashboard (Power BI/Tableau) trong `dashboards/`
...
| AUC-ROC | ≥ 0.68 | | ☐ |
| KS Statistic | ≥ 0.25 | | ☐ |
| Gini Coefficient | Report song song | | ☐ |
| Expected Net Return theo cutoff | So với baseline | | ☐ |
| Bad rate tại approval rate cố định | So với duyệt ngẫu nhiên | | ☐ |
| Số lượng segment rủi ro | 3–5 nhóm | | ☐ |

### 4.3. Toàn bộ 6 deliverables (PROPOSAL.md mục 9)
1. ☐ Business Requirement Document
2. ☐ EDA & Risk Analysis Report
3. ☐ Risk Scoring Model
4. ☐ Business Rules & Policy/Profitability Recommendation
5. ☐ Dashboard
